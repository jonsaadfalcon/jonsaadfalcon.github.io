...
<p style="font-size: 0.92rem; color: #555; line-height: 1.7;">Selected industry, analyst, and community references to <em>Intelligence per Watt</em> as a metric for AI efficiency.</p>
...
<h3 style="font-family: Georgia, serif; font-size: 1rem; font-weight: 700; color: #2E7D6F; margin-top: 24px; margin-bottom: 8px;">Community &amp; Social</h3>
<ul class="pub-list">
{% for item in site.data.ipw-coverage %}
